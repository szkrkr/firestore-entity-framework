...
export default class Entry {
    constructor(entity, id, state = EntityState.Unchanged) {
        /**
         * @description
         * remove entity
         *
         ...
         */
        this.modifyEntity = (value) => {
            let _entry = Object.assign({}, this);
        ...
        this.resumeEntity = () => {
            ...
            if (_entry.state === EntityState.Deleted || _entry.state === EntityState.Mofified) {
                _entry.state = EntityState.Unchanged;
                if (_entry.original) {
